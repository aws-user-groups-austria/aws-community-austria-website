...
export function Layout() {
  ...
  return (
    ...
    >
          ...
          <div className="nav-links" style={{ display: "flex", gap: "28px", alignItems: "center" }}>
            {NAV_LINKS.map((item) => (
              <Link
                key={item.to}
                to={item.to}
                style={{ color: "#D8D8D8", textDecoration: "none", fontSize: "14px", fontWeight: 500 }}
      ...
      {/* Footer */}
      <footer style={{ background: "#1E2538", borderTop: "1px solid #2F2B52" }}>
        {/* Main footer grid */}
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "60px 40px 48px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "48px" }}>

          {/* Col 1: Brand */}
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
              <img src={`${import.meta.env.BASE_URL}assets/logos/awscommunityaustria.png`} alt="AWS User Groups Austria" style={{ height: "40px", objectFit: "contain" }} />
              <span style={{ fontSize: "15px", fontWeight: 700, color: "#FFFFFF", lineHeight: 1.3 }}>AWS User Groups<br />Austria</span>
            </div>
            ...
            <div style={{ display: "flex", gap: "14px" }}>
              <a href="https://www.linkedin.com/groups/8995348/" target="_blank" rel="noopener noreferrer" style={{ color: "#9CA3AF" }}
                onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = "#A66FF0"}
              ...
              <a href="https://github.com/aws-usergroup-vienna" target="_blank" rel="noopener noreferrer" style={{ color: "#9CA3AF" }}
                onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = "#A66FF0"}
                onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = "#9CA3AF"}>
              ...
              <a href="https://join.slack.com/t/awscommunitydach" target="_blank" rel="noopener noreferrer" style={{ color: "#9CA3AF" }}
                onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = "#A66FF0"}
                onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = "#9CA3AF"}>
          ...
          <div>
            <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#A66FF0", marginBottom: "20px", textTransform: "uppercase", letterSpacing: "0.5px" }}>Our User Groups</h3>
              ...
              {[
                ...
                <li key={g.label}>
                  <a href={g.url} target="_blank" rel="noopener noreferrer"
                    style={{ display: "flex", alignItems: "center", gap: "10px", color: "#9CA3AF", textDecoration: "none", fontSize: "14px" }}
                    onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = "#A66FF0"}
                    onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = "#9CA3AF"}>
                    {g.logo
                      ? <img src={g.logo} alt={g.label} style={{ width: "28px", height: "28px", borderRadius: "50%", objectFit: "cover", flexShrink: 0 }} />
                      : <svg width="28" height="28" fill="currentColor" viewBox="0 0 24 24" style={{ color: "#A66FF0", flexShrink: 0 }}><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>
                    }
                    {g.label}
                  </a>
                </li>
          ...
          {/* Col 3: Resources */}
          <div>
            <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#A66FF0", marginBottom: "20px", textTransform: "uppercase", letterSpacing: "0.5px" }}>Resources</h3>
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              <div style={{ background: "rgba(166,111,240,0.08)", border: "1px solid #2F2B52", borderRadius: "8px", padding: "14px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20" style={{ color: "#A66FF0", flexShrink: 0 }}><path fillRule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm3.293 1.293a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414L7.586 10 5.293 7.707a1 1 0 010-1.414zM11 12a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd"/></svg>
                  <span style={{ fontSize: "14px", fontWeight: 700, color: "#FFFFFF" }}>User Group Toolkit</span>
                </div>
                <p style={{ fontSize: "12px", color: "#9CA3AF", marginBottom: "8px", lineHeight: 1.5 }}>Access resources and materials for AWS User Group organizers and members.</p>
                <a href="https://aws.amazon.com/developer/community/usergroups/resources/" target="_blank" rel="noopener noreferrer"
                  style={{ fontSize: "12px", color: "#A66FF0", textDecoration: "none", display: "flex", alignItems: "center", gap: "4px" }}>
                  Learn more
              ...
              <div style={{ background: "rgba(166,111,240,0.08)", border: "1px solid #2F2B52", borderRadius: "8px", padding: "14px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20" style={{ color: "#A66FF0", flexShrink: 0 }}><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"/></svg>
                  <span style={{ fontSize: "14px", fontWeight: 700, color: "#FFFFFF" }}>Useful Information</span>
                </div>
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  <div style={{ fontSize: "12px", color: "#9CA3AF" }}>
                    <strong style={{ color: "#D8D8D8" }}>Meetup Prep Guide:</strong><br />
                    <a href="https://drive.google.com/file/d/1c0GqUhp8kFLHAIOGp4LSbKKwath6ZXcV/view" target="_blank" rel="noopener noreferrer" style={{ color: "#A66FF0", textDecoration: "none" }}>Download PDF Guide</a>
                  </div>
                  <div style={{ fontSize: "12px", color: "#9CA3AF" }}>
                    <strong style={{ color: "#D8D8D8" }}>Submit a Talk:</strong><br />
                    <a href="https://sessionize.com/aws-community-austria" target="_blank" rel="noopener noreferrer" style={{ color: "#A66FF0", textDecoration: "none" }}>Sessionize - AWS Community Austria</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Col 4: Community */}
          <div>
            <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#A66FF0", marginBottom: "20px", textTransform: "uppercase", letterSpacing: "0.5px" }}>Community</h3>
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "14px" }}>
              {[
                ...
                <li key={item.label}>
                  <a href={item.url} target="_blank" rel="noopener noreferrer"
                    ...
                    onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = "#A66FF0"}
                    onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = "#9CA3AF"}>
                    <svg width="18" height="18" fill="currentColor" viewBox="0 0 20 20" style={{ color: "#A66FF0", flexShrink: 0 }}>{item.icon}</svg>
                    {item.label}
                  </a>
                </li>
              ))}
        ...
        {/* Bottom bar */}
        <div style={{ background: "#161E2D", borderTop: "1px solid #2F2B52" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "18px 40px", display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: "12px" }}>
            <div style={{ display: "flex", flexWrap: "wrap", gap: "24px" }}>
              {[
                ...
                <a key={item.label} href={item.href} target={item.href.startsWith("mailto") ? undefined : "_blank"} rel="noopener noreferrer"
                  style={{ display: "flex", alignItems: "center", gap: "6px", color: "#9CA3AF", textDecoration: "none", fontSize: "13px" }}
                  onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = "#A66FF0"}
                  onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = "#9CA3AF"}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "13px", color: "#9CA3AF" }}>
              <span>© 2026 AWS User Groups Austria</span>
              <span style={{ color: "#4B5563" }}>|</span>
              <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                Made with
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 20 20" style={{ color: "#ef4444" }}><path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd"/></svg>
